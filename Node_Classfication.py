...
from src.Utils import load_our_data, get_model, load_our_data2
...
# adj_fused, features_fused, labels, idx_train, idx_val, idx_test = load_our_data2(args.dataset, args.cuda)
...
collect_ma.append(f1_ma)
collect_mi.append(f1_mi)
print(collect_ma+collect_mi)
